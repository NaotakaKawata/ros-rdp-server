...
```
#melodic
$ docker run --rm -it -p 13389:3389 -p 10022:22 --shm-size=1024m -v <ホスト側のマウントしたいディレクトリの絶対パス>:/home/user/Workdir/:rw naotakakawata/melodic-rdp-server
#noetic
$ docker run --rm -it -p 13389:3389 -p 10022:22 --shm-size=1024m -v <ホスト側のマウントしたいディレクトリの絶対パス>:/home/user/Workdir/:rw naotakakawata/noetic-rdp-server
```
